...
| Model | p | d | q | Function | Equation ($D=\text{Demand}$) |
|:-----:|:-:|:-:|:-:|:---------|:---------|
...
CPS then has a max capacity of $35000+20000+10000+10000+10000=85000$ MWh at a cost of $(50+56+70+45+45) \times 85000 = 22,610,000$ USD. Below is a plot of the test set capacity by power source.
